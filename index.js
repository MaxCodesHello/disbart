...
client.on("message", (message) => {
  ...
  if (message.content.startsWith("!greeting")) {
    message.channel.send(`I'm disbart who the heck are you? Wait never mind, you are <@${message.author.id}>. Okay well hi there! I have got a ton of features so use command !help to test them all! have fun lol!\n`);
  }
...
//DONT CHANGE BETWEEN LINE 59 AND 61
...
//FOR REPL USERS, IF YOU DONT USE REPL DELETE BELOW THIS
